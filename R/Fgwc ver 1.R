...
load("D:/My Drive/deden-RMarkdown & Github/PDP-SoVI/Data/sovi_data_Kab_R.RData")
...
load("D:/My Drive/deden-RMarkdown & Github/PDP-SoVI/Data/pop.rdata")
...
# FGWC Standart
Res_fgwc <- fgwc(data=sovi_data_kab_full_R, pop=Sovi_Pop, distmat=mat_dist, algorithm = "classic", param_fgwc,1)
